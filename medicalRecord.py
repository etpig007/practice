...
#NE
General = LabelFrame(main, text='NE', labelanchor='n')
Label(General, text='GCS: ').grid(row=0)
Entry(General, width=10 ,textvariable=GCS).grid(row=0,column=1)
Label(General, text='VAS: ').grid(row=1)
Entry(General, width=10 ,textvariable=VAS).grid(row=1,column=1)
Label(General, text='Pupil(L/R): ').grid(row=2)
Entry(General, width=10 ,textvariable=Pupil).grid(row=2,column=1)
